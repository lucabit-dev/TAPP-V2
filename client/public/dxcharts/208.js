...
`,A=e['Ay']['form']['withConfig']({'displayName':'DXChart-ChartSettingsTabForm','componentId':'DXChart-1f81gd3'})``;},0xcbf0:(a,b,c)=>{c['r'](b),c['d'](b,{'ChartSettingsTradingContainer':()=>v,'default':()=>w});var d=c(0x12e5c),e=c(0xf8d0),f=c(0x8c58),g=c(0x65f5),h=c(0xc712),i=c(0xd114),j=c(0x3ffe),k=c(0xb116),l=c(0x147f4),m=c(0x6620),n=c(0x8bd),o=c(0x12fa0),p=c(0xc1d),q=c(0x13c93);;const r=(0x0,o['Ay'])((0x0,p['G']))['withConfig']({'displayName':'DXChart-ChartSettingsTradingTypeGroupStyled','componentId':'DXChart-1kox3wx'})`
	margin-inline-start: var(--spacer-6);
	${q['H']} {
		margin: 0;
	}
`,s=o['Ay']['div']['withConfig']({'displayName':'DXChart-ChartSettingsTabTradingDivider','componentId':'DXChart-y3yyqz'})`
	width: 100%;
	height: 1px;
	margin-top: var(--spacer-1);
	margin-bottom: var(--spacer-1);
	background-color: var(--menu-divider);
`;;const t=(0x0,e['memo'])(x=>{const {settings:y,localization:z,onValueChange:A,a11yTabProps:{role:B,id:C,ariaLabelledBy:D},showRestoreToDefault:E,onRestoreDefaultRequest:F,tradingAllowed:G}=x,H=(0x0,e['useCallback'])((N=![])=>{A((0x0,k['K'])(['chartReact','trading','showOrders']),N);},[A]),I=(0x0,e['useCallback'])((N=![])=>{A((0x0,k['K'])(['chartReact','trading','showPositions']),N);},[A]),J=(0x0,e['useCallback'])((N=![])=>{A((0x0,k['K'])(['chartReact','trading','executedOrders','enabled']),N);},[A]),K=(0x0,e['useCallback'])((N=![])=>{A((0x0,k['K'])(['chartReact','trading','visible']),N),A((0x0,k['K'])(['chartReact','trading','showOrders']),N),A((0x0,k['K'])(['chartReact','trading','showPositions']),N),A((0x0,k['K'])(['chartReact','trading','executedOrders','enabled']),N);},[A]),L=(0x0,e['useMemo'])(()=>[{'name':z['trading']['executedOrders']['bubbles'],'type':'bubbles','ariaLabel':z['trading']['executedOrders']['bubbles']},{'name':z['trading']['executedOrders']['labels'],'type':'labels','ariaLabel':z['trading']['executedOrders']['labels']}],[z]),M=(0x0,e['useCallback'])(N=>A((0x0,k['K'])(['chartReact','trading','executedOrders','displayMode']),N),[A]);return e['createElement'](n['au'],null,e['createElement'](m['PY'],{'role':B,'id':C,'aria-labelledby':D},e['createElement'](l['z'],{'disabled':!G,'label':z['settingsPopup']['tabs']['trading']['tradingFromChart'],'value':y['visible']&&G,'onValueChange':K}),e['createElement'](l['z'],{'disabled':!(y['visible']&&G),'label':z['settingsPopup']['tabs']['trading']['showOrders'],'value':y['showOrders']&&G,'onValueChange':H}),e['createElement'](l['z'],{'disabled':!(y['visible']&&G),'label':z['settingsPopup']['tabs']['trading']['showPositions'],'value':y['showPositions']&&G,'onValueChange':I})),e['createElement'](s,null),e['createElement'](l['z'],{'disabled':!(y['visible']&&G),'label':z['settingsPopup']['tabs']['trading']['showExecutedOrders'],'value':y['executedOrders']['enabled']&&G,'onValueChange':J}),e['createElement'](r,{'buttons':L,'selected':y['executedOrders']['displayMode'],'onSelect':M,'ariaLabel':z['trading']['executedOrders']['buttons']['a11y_orderMode'],'isDisabled':!y['executedOrders']['enabled']}),E&&e['createElement'](n['ov'],{'onClick':F},z['settingsPopup']['resetToDefaultsBtn']));}),u=null&&t;;const v=f['_O']['combine'](f['_O']['key']()('chartConfiguratorViewModel'),x=>(0x0,g['s'])('ChartSettingsTradingContainer',y=>{const {localization:z}=(0x0,e['useContext'])(j['e']),A=(0x0,i['k'])(x['state'],['settings','chartReact','trading']),{defaultConfig:B}=y,C=(0x0,h['NC'])(x['tradingAllowed']),D=(0x0,e['useMemo'])(()=>!(0x0,d['bD'])(B['chartReact']['trading'],A),[A,B]),E=(0x0,e['useCallback'])(()=>x['onRestoreDefaultConfigTab'](B),[B]);return(0x0,e['createElement'])(t,{'showRestoreToDefault':D,'localization':z,'onValueChange':x['setSettingsByPath'],'settings':A,'tradingAllowed':C,'a11yTabProps':y['a11yTabProps'],'onRestoreDefaultRequest':E});})),w=v;},0x13c93:(a,b,c)=>{c['d'](b,{'H':()=>g,'l':()=>f});var d=c(0x12fa0),e=c(0xa277);const f=d['Ay']['div']['withConfig']({'displayName':'DXChart-ButtonsRadioGroupStyled','componentId':'DXChart-c1qbei'})`
	display: flex;
